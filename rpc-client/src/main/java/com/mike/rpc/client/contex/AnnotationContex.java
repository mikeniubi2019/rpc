...
import com.mike.rpc.client.channelHandler.ReconnectHandler;
...
public class AnnotationContex extends AbstractContex{
    ...
    public void doRegistChannelHandler() {
        ...
        super.getChannelHandlers().add(new ReconnectHandler(this));
        super.getChannelHandlers().add(new SendRequestHandler());
